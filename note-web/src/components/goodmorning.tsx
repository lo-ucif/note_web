...
export default function Goodmorning() {
  return (
    <div className="flex py-2.5 px-5 flex-row justify-between w-full basecolor h-fit">
      <div className="flex items-center">Good Morning, Ahmed !</div>
      <div className="flex gap-5 items-center justify-center p-2.5 color rounded-full">
        <svg
