...
//add note in the db
export const addnote = async (res: Response, req: Request) => {
  try {
...
export const getallnote = async (res: Response, req: Request) => {
  try {
...
export const getnotebyid = async (res: Response, req: Request) => {
  try {
...
export const deletnote = async (res: Response, req: Request) => {
  try {
...
export const deletallnote = async (res: Response, req: Request) => {
  try {
...
export const updatenote = async (res: Response, req: Request) => {
  try {
    const noteupdated = await note.findByIdAndUpdate(req.params.id, req.body);
  } catch (error) {}
};
// update state (completed or not completed)
export const updatestate = async (res: Response, req: Request) => {
  try {
